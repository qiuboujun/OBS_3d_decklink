...
#define ENABLE_3D "enable_3d"
#define EYE_SELECT "eye_select"
...
#define TEXT_ENABLE_3D obs_module_text("Enable3D")
#define TEXT_EYE_SELECT obs_module_text("EyeSelect")
#define TEXT_EYE_LEFT obs_module_text("EyeSelect.Left")
#define TEXT_EYE_RIGHT obs_module_text("EyeSelect.Right")
